...
extern size_t
__envoy_dynamic_module_http_get_request_header_value(void* headers, void* key, size_t key_length,
                                                     void** result_buffer_ptr,
                                                     size_t* result_buffer_length_ptr);

extern size_t
__envoy_dynamic_module_http_get_response_header_value(void* headers, void* key, size_t key_length,
                                                      void** result_buffer_ptr,
                                                      size_t* result_buffer_length_ptr);
...
size_t __envoy_dynamic_module_http_on_request_headers(void* envoy_filter_ptr, void* context_ptr,
  ...
  __envoy_dynamic_module_http_get_request_header_value(headers, key, key_length, &result_buffer_ptr,
...
int __envoy_dynamic_module_http_on_response_headers(void* envoy_filter_ptr, void* context_ptr,
  ...
  void* result_buffer_ptr;
  size_t result_buffer_length;
  __envoy_dynamic_module_http_get_response_header_value(headers, key, key_length,
                                                        &result_buffer_ptr, &result_buffer_length);
  // Check if the header value is "value".
  void* value = "bar";
